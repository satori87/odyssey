...
public class Floater {
	...
	public Floater(Sprite e, int x, int y, String text, Color col, long aliveAt) {
		this.speed = 0.5f;
	...
	public void render(long tick) {
		...
		Scene.scene.drawFont(0, e.trueX() + Math.round(x), e.trueY() + Math.round(y), text, true, 1.4f, c);
	}
